...
<div align="center" style="height:150px"><h1 align="center" style="margin-top:10px;color:white;">PENNANT HOSPITAL</h1></div>
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            
            <form id="page" action="http://localhost:8080/DoctorAppointment/doctorverify" method="get">
